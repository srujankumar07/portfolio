  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        <h3 className="text-3xl font-bold font-nunito text-cyan-400">Srujan Kumar Balgoni</h3>

        <p className="text-base text-white font-nunito tracking-wide">
        ...
        <p className="text-base text-white flex items-center gap-2">
          <span className="text-cyan-400 font-nunito">Phone:</span> <span className="text-lightText font-nunito">+91 9346424298</span>
        </p>
        <p className="text-base text-white flex items-center gap-2">
          <span className="text-cyan-400 font-nunito">Email:</span>{" "}
          <span className="text-white font-nunito">balgonisrujan2002@gmail.com</span>
        </p>
      </div>
      <div className="flex flex-col gap-4">
        <h2 className="text-white uppercase mb-4 font-nunito">Find me in</h2>
